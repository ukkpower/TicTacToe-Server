...
namespace Scripts.Models {
	class MatchModel {
		...
		public MatchModel(PlayerModel player1) {

			id = MatchHelper.Random8DigitNumber();
		...
		public void AddPlayerToMatch(PlayerModel player2)
		{
        ...
        public void StartMatch()
        {
			...
			{
                writer.Write(id);
                writer.Write(currentPlayerClientID);
                using (Message msg = Message.Create((ushort)Tags.Tag.MATCH_STARED, writer))
                {
